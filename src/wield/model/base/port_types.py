...
ALLOWED_PARTNERS = {
    BGT_OPTICS_PHYSICAL: [BGT_OPTICS_PHYSICAL, BGT_OPTICS_VIRTUAL],
    BGT_OPTICS_VIRTUAL: [BGT_OPTICS_PHYSICAL, BGT_OPTICS_VIRTUAL],
    BGT_ELECTRONICS_PHYSICAL: [
        BGT_ELECTRONICS_GLOB,
        BGT_ELECTRONICS_PHYSICAL,
        BGT_ELECTRONICS_VIRTUAL,
    ],
    BGT_ELECTRONICS_VIRTUAL: [BGT_ELECTRONICS_PHYSICAL, BGT_ELECTRONICS_VIRTUAL],
    BGT_ELECTRONICS_GLOB: [BGT_ELECTRONICS_PHYSICAL],
    BGT_MECHANICS_PHYSICAL: [
        BGT_MECHANICS_PHYSICAL,
        BGT_MECHANICS_VIRTUAL,
        BGT_MECHANICS_GLOB,
    ],
    BGT_MECHANICS_VIRTUAL: [BGT_MECHANICS_PHYSICAL, BGT_MECHANICS_VIRTUAL],
    BGT_MECHANICS_GLOB: [BGT_MECHANICS_PHYSICAL],
    BGT_RB_MECHANICS_PHYSICAL: [
        BGT_RB_MECHANICS_PHYSICAL,
        BGT_RB_MECHANICS_VIRTUAL,
        BGT_RB_MECHANICS_GLOB,
    ],
    BGT_RB_MECHANICS_VIRTUAL: [BGT_RB_MECHANICS_PHYSICAL, BGT_RB_MECHANICS_VIRTUAL],
    BGT_RB_MECHANICS_GLOB: [BGT_RB_MECHANICS_PHYSICAL],
