                ...
                if manip.is_DC:
                    ...
                    for fK in basis_to['frequency'].enumerated:
                        field_to_p = base.KeyMatrixDiff(
                            stR = (basis_to['frequency'], base.kg_twophoton_pm, ),
                            kmatrix = {(fK, '+',) : {() : [[1]]}},
                            build = True,
                        )
                        ...
                        inner_prod_p = base.KeyMatrixSame(
                            stR = (basis_fr['frequency'], base.kg_twophoton_pm, ),
                            stC = (basis_fr['frequency'], base.kg_twophoton_pm, ),
                            kmatrix = km_p,
                            build = True,
                        )
                        ...
                        if projection_full == 0:
                            ...
                            projection_full = (projection_p + projection_m) + projection_full
