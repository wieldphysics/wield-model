...
from transient.utilities.future_from_2 import str, object, repr_compat, super
from transient.utilities.print import pprint
...
class SystemSolver(object):
    ...
    def views(self):
        return declarative.DeepBunch(writeable = False)
